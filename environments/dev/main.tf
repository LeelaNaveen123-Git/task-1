...
module "s3" {
  ...
  # IMPORTANT:
  # The S3 module variable is versioning_enabled,
...
module "ec2" {
  ...
  # IMPORTANT:
  # The EC2 module does NOT have a vpc_id variable.
  # The subnet already determines the VPC.
  subnet_id = lookup(
  ...
  # The EC2 module expects iam_instance_profile,
  # not iam_role_name.
  #
  # Set to null unless your EC2 module creates/uses
  # an instance profile separately.
